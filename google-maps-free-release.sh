...
GITHUB_REPO_NAME="Google-Maps-Builder"
...
rm -Rf .idea
rm -Rf .github
rm -Rf vendor/wordimpress/maps-builder-core/.git
rm -f vendor/wordimpress/maps-builder-core/README.md
rm -f vendor/wordimpress/maps-builder-core/composer.json
rm -f .bowerrc
